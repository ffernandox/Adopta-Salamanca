...
export default function HistoriasExito() {
  ...
  const historias = [
    ...
    {
      category: "Historias Felices",
      title: "Paco encontró amor",
      src: "https://images.unsplash.com/photo-1518020382113-a7e8fc38eac9?q=80&w=1017&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      quote: "Ahora es el rey de su nuevo hogar."
    },
    {
      category: "Historias Felices",
      title: "Dani encontró un hogar",
      src: "https://images.unsplash.com/photo-1588943211346-0908a1fb0b01?q=80&w=1035&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
      quote: "Su sonrisa lo dice todo, es feliz por fin."
    },
  ];

  return (
    <section id="historias" className="w-full py-20 bg-white overflow-hidden">
