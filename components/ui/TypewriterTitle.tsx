...
export default function TypewriterTitle({
  ...
  // Actualizamos la referencia si cambian las props
  useEffect(() => {
  ...
  return (
    <div className="relative w-full max-w-5xl mx-auto py-2 mb-6">
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        <motion.div
          animate={{ opacity: 1 }}
          className="flex items-center justify-center gap-1 font-bold text-4xl md:text-5xl text-black tracking-tight"
          initial={{ opacity: 0 }}
        ...
        >
          ...
          <motion.span
            ...
            className="inline-block h-[1em] w-[4px] bg-black ml-1 align-middle"
            transition={{
              duration: 1,
